...
export const metadata = createPageMetadata({ title: "Projekte", description: "Fiktive Referenzprojekte für Photovoltaik, Speicher und Wallboxen in Nordrhein-Westfalen.", path: "/projekte" });
